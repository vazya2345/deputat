...
class MyRbacController extends Controller {
    ...
    public function actionInit() {
        ...
        $deputat = $auth->createRole('deputat');
        ...
        $updateNews = $auth->createPermission('updateMurojats');
        $updateNews->description = 'Редактирование обращений';
        ...
        $auth->addChild($deputat,$updateNews);

        // админ наследует роль редактора новостей. Он же админ, должен уметь всё! :D
        $auth->addChild($admin, $deputat);
